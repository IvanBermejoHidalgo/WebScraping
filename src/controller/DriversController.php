...
class DriversController {
    ...
    public static function addDriver($first_name, $last_name, $team, $country, $flag_url, $piloto_img) {
        $sql = "INSERT INTO drivers (first_name, last_name, team, country, flag_url, piloto_img) 
                VALUES (:first_name, :last_name, :team, :country, :flag_url, :piloto_img)";
    ...
    public static function editDriver($id, $first_name, $last_name, $team, $country, $flag_url, $piloto_img) {
        $sql = "UPDATE drivers 
                SET first_name = :first_name, last_name = :last_name, team = :team, 
